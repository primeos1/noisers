...
class ValeContentController extends Controller
{
    ...
    public function update(Request $request)
    {
        ...
        $validated = $request->validate([
            ...
            'team_lineup_player_ids' => ['sometimes', 'nullable', 'array'],
            'team_lineup_player_ids.*' => ['integer'],

            'potw_player_id' => ['sometimes', 'nullable', 'integer', 'exists:players,id'],
            'potw_note' => ['sometimes', 'nullable', 'string'],
            'potw_rating' => ['sometimes', 'nullable', 'numeric', 'min:0', 'max:10'],

            'improved_player_id' => ['sometimes', 'nullable', 'integer', 'exists:players,id'],
